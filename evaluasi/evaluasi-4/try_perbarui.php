...
<body>
    <div class="wrapper">
        <form method="post" action="">
          ...
          <div class="group">
            <input type="text" name="nama" value="<?php echo $data_santri['nama']; ?>" required="required"/><span class="highlight"></span><span class="bar"></span>
            <label>Nama Santri: <?php echo $data_santri['nama']; ?> > </label>
          </div>
          <div class="group">
            <input type="text" name="divisi" value="<?php echo $data_santri['divisi']; ?>" required="required"/><span class="highlight"></span><span class="bar"></span>
            <label>Divisi: <?php echo $data_santri['divisi']; ?> > </label>
          </div>
          <div class="group">
            <input type="text" name="asal" value="<?php echo $data_santri['asal']; ?>" required="required"/><span class="highlight"></span><span class="bar"></span>
