...
<nav class="navtop">
    ...
    <div class="bungkusantable">
        <table class="data_santri">
                    <tr><td colspan="4"><td colspan="4"><div class="btn-box"><a href="login_page/try_register.php" class="btn btn-success">Tambah Data</a></div></td></td></tr>
                    <tr>
                        <th>ID</th>
                        <th>Username</th>
                        <th>Password</th>
